...
import { TaskColorCommand } from "./Task/TaskProperties/TaskColorCommand";
import { TaskDescriptionCommand } from "./Task/TaskProperties/TaskDescriptionCommand";
import { TaskEndCommand } from "./Task/TaskProperties/TaskEndCommand";
import { TaskMoveCommand } from "./Task/TaskProperties/TaskMoveCommand";
import { TaskProgressCommand } from "./Task/TaskProperties/TaskProgressCommand";
import { TaskStartCommand } from "./Task/TaskProperties/TaskStartCommand";
import { TaskTitleCommand } from "./Task/TaskProperties/TaskTitleCommand";
...
export class CommandManager {
    ...
    get changeTaskTitleCommand(): TaskTitleCommand { return new TaskTitleCommand(this.control); }
    get changeTaskDescriptionCommand(): TaskDescriptionCommand { return new TaskDescriptionCommand(this.control); }
    get changeTaskProgressCommand(): TaskProgressCommand { return new TaskProgressCommand(this.control); }
    get changeTaskColorCommand(): TaskColorCommand { return new TaskColorCommand(this.control); }
    get changeTaskStartCommand(): TaskStartCommand { return new TaskStartCommand(this.control); }
    get taskMoveCommand(): TaskMoveCommand { return new TaskMoveCommand(this.control); }
    get changeTaskEndCommand(): TaskEndCommand { return new TaskEndCommand(this.control); }
