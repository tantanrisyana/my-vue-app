...
import { DataExportMode, IPdfExportRangeProps, PdfDataRange } from "./Props";
...
export class TaskAreaExportHelper {
    ...
    public get resourcesElements(): Array<HTMLElement> {
        this._resourcesElements ??= this.visibleTaskIndices.map(tIndex => this._owner.renderHelper.resourcesElements[tIndex]).filter(r => r && r.parentElement); 
