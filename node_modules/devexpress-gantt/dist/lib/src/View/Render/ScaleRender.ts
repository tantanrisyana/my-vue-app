...
export class ScaleRender {
    ...
    createScaleElement(index: number, scaleIndex: number, scaleType: ViewType): void {
        const info = this.gridLayoutCalculator.getScaleElementInfo(index, scaleType);
    ...
    createScaleBorder(index: number, scaleIndex: number, scaleType: ViewType): void {
