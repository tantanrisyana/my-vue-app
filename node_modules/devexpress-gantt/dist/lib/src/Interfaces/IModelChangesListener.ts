...
export interface IModelChangesListener {
    ...
    NotifyTaskTitleChanged(taskId: any, newValue: string, errorCallback: () => void);
    NotifyTaskDescriptionChanged(taskId: any, newValue: string, errorCallback: () => void);
    NotifyTaskStartChanged(taskId: any, newValue: Date, errorCallback: () => void);
    NotifyTaskEndChanged(taskId: any, newValue: Date, errorCallback: () => void);
    NotifyTaskProgressChanged(taskId: any, newValue: number, errorCallback: () => void);
    NotifyTaskColorChanged(taskId: any, newValue: string, errorCallback: () => void);
