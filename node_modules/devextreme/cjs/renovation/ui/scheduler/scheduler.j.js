...
var Scheduler = function(_BaseComponent) {
    ...
    _proto.getComponentInstance = function() {
        var _this$viewRef;
        return null === (_this$viewRef = this.viewRef) || void 0 === _this$viewRef ? void 0 : _this$viewRef.getComponentInstance.apply(_this$viewRef, arguments)
    };
    _proto.addAppointment = function(appointment) {
        var _this$viewRef2;
        return null === (_this$viewRef2 = this.viewRef) || void 0 === _this$viewRef2 ? void 0 : _this$viewRef2.addAppointment.apply(_this$viewRef2, arguments)
    };
    _proto.deleteAppointment = function(appointment) {
        var _this$viewRef3;
        return null === (_this$viewRef3 = this.viewRef) || void 0 === _this$viewRef3 ? void 0 : _this$viewRef3.deleteAppointment.apply(_this$viewRef3, arguments)
    };
    _proto.updateAppointment = function(target, appointment) {
        var _this$viewRef4;
        return null === (_this$viewRef4 = this.viewRef) || void 0 === _this$viewRef4 ? void 0 : _this$viewRef4.updateAppointment.apply(_this$viewRef4, arguments)
    };
    _proto.getDataSource = function() {
        var _this$viewRef5;
        return null === (_this$viewRef5 = this.viewRef) || void 0 === _this$viewRef5 ? void 0 : _this$viewRef5.getDataSource.apply(_this$viewRef5, arguments)
    };
    _proto.getEndViewDate = function() {
        var _this$viewRef6;
        return null === (_this$viewRef6 = this.viewRef) || void 0 === _this$viewRef6 ? void 0 : _this$viewRef6.getEndViewDate.apply(_this$viewRef6, arguments)
    };
    _proto.getStartViewDate = function() {
        var _this$viewRef7;
        return null === (_this$viewRef7 = this.viewRef) || void 0 === _this$viewRef7 ? void 0 : _this$viewRef7.getStartViewDate.apply(_this$viewRef7, arguments)
    };
    _proto.hideAppointmentPopup = function(saveChanges) {
        var _this$viewRef8;
        return null === (_this$viewRef8 = this.viewRef) || void 0 === _this$viewRef8 ? void 0 : _this$viewRef8.hideAppointmentPopup.apply(_this$viewRef8, arguments)
    };
    _proto.hideAppointmentTooltip = function() {
        var _this$viewRef9;
        return null === (_this$viewRef9 = this.viewRef) || void 0 === _this$viewRef9 ? void 0 : _this$viewRef9.hideAppointmentTooltip.apply(_this$viewRef9, arguments)
    };
    _proto.scrollTo = function(date, group, allDay) {
        var _this$viewRef10;
        return null === (_this$viewRef10 = this.viewRef) || void 0 === _this$viewRef10 ? void 0 : _this$viewRef10.scrollTo.apply(_this$viewRef10, arguments)
    };
    _proto.scrollToTime = function(hours, minutes, date) {
        var _this$viewRef11;
        return null === (_this$viewRef11 = this.viewRef) || void 0 === _this$viewRef11 ? void 0 : _this$viewRef11.scrollToTime.apply(_this$viewRef11, arguments)
    };
    _proto.showAppointmentPopup = function(appointmentData, createNewAppointment, currentAppointmentData) {
        var _this$viewRef12;
        return null === (_this$viewRef12 = this.viewRef) || void 0 === _this$viewRef12 ? void 0 : _this$viewRef12.showAppointmentPopup.apply(_this$viewRef12, arguments)
    };
    _proto.showAppointmentTooltip = function(appointmentData, target, currentAppointmentData) {
        ...
        return null === (_this$viewRef13 = this.viewRef) || void 0 === _this$viewRef13 ? void 0 : _this$viewRef13.showAppointmentTooltip.apply(_this$viewRef13, _toConsumableArray(params.slice(0, arguments.length)))
    };
