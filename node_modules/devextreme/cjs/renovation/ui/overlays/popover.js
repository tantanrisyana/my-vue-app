/**
 * DevExtreme (cjs/renovation/ui/overlays/popover.js)
 * Version: 21.2.15
...
var viewFunction = function(_ref) {
    ...
    return (0, _inferno.normalizeProps)((0, _inferno.createComponentVNode)(2, _dom_component_wrapper.DomComponentWrapper, _extends({
        componentType: _popover.default,
...
var PopoverProps = Object.create(Object.prototype, _extends(Object.getOwnPropertyDescriptors(_base_props.BaseWidgetProps), Object.getOwnPropertyDescriptors(Object.defineProperties({
...
var Popover = function(_InfernoComponent) {
    ...
    _createClass(Popover, [{
        ...
        get: function() {
            var _this$props$visible = _extends({}, this.props, {
                ...
                restProps = (_this$props$visible.accessKey, _this$props$visible.activeStateEnabled, _this$props$visible.animation, _this$props$visible.children, _this$props$visible.className, _this$props$visible.closeOnOutsideClick, _this$props$visible.container, _this$props$visible.contentTemplate, _this$props$visible.defaultVisible, _this$props$visible.deferRendering, _this$props$visible.disabled, _this$props$visible.focusStateEnabled, _this$props$visible.height, _this$props$visible.hideEvent, _this$props$visible.hint, _this$props$visible.hoverStateEnabled, _this$props$visible.maxHeight, _this$props$visible.maxWidth, _this$props$visible.minHeight, _this$props$visible.minWidth, _this$props$visible.onClick, _this$props$visible.onHidden, _this$props$visible.onHiding, _this$props$visible.onInitialized, _this$props$visible.onKeyDown, _this$props$visible.onOptionChanged, _this$props$visible.onShowing, _this$props$visible.onShown, _this$props$visible.onTitleRendered, _this$props$visible.position, _this$props$visible.rtlEnabled, _this$props$visible.shading, _this$props$visible.shadingColor, _this$props$visible.showCloseButton, _this$props$visible.showEvent, _this$props$visible.showTitle, _this$props$visible.tabIndex, _this$props$visible.target, _this$props$visible.title, _this$props$visible.titleTemplate, _this$props$visible.toolbarItems, _this$props$visible.visible, _this$props$visible.visibleChange, _this$props$visible.width, _objectWithoutProperties(_this$props$visible, _excluded));
            return restProps
        }
    }]);
    return Popover
